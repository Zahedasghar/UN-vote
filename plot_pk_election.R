...
library(readr)
library(tidyverse)
constituency_data <- read_csv("https://raw.githubusercontent.com/colincookman/pakistan_elections/master/data/pk_constituency_data.csv")  # load candidate data


constituency_data$election_date <- ymd(constituency_data$election_date)
